...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "date_desc",
                        "description": "Ordenação: date_asc ou date_desc",
                        "name": "order",
                        "in": "query"
                    }
                ],
        ...
        "/products/promo-post": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dados da publicação promocional",
                        "name": "post",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreatePromoPostRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.PromoCountResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/users/{id}/follow/{userIdToFollow}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "name_asc",
                        "description": "Ordenação: name_asc ou name_desc",
                        "name": "order",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.FollowedListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.FollowersCountResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.FollowersListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/users/{id}/unfollow/{userIdToFollow}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "request.CreatePromoPostRequest": {
            "type": "object",
            "required": [
                "category",
                "date",
        ...
        "response.FollowersCountResponse": {
            "type": "object",
            "properties": {
                "followers_count": {
                    "type": "integer"
        ...
        "response.PostDTO": {
            ...
            "properties": {
                ...
                "product": {
                    "$ref": "#/definitions/response.ProductDTO"
                },
                "user_id": {
                    "type": "integer"
                }
        ...
        "response.PostListResponse": {
            ...
            "properties": {
                "posts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.PostDTO"
                    }
                },
                "user_id": {
                    "type": "integer"
